import{_ as s,c as a,o as n,d as l}from"./app.0a4ff61d.js";const i=JSON.parse('{"title":"Yarn","description":"","frontmatter":{"title":"Yarn","lastUpdated":true},"headers":[],"relativePath":"developer/others/yarn.md","lastUpdated":1678959422000}'),p={name:"developer/others/yarn.md"},o=l(`<div class="language-sh"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#676E95;font-style:italic;"># 显示命令列表</span></span>
